      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        <header className="mb-10 text-center">
          ...
          <p className="mt-2 text-slate-600">
            Sube un PDF, publícalo en internet y genera un QR optimizado para lectura en móviles.
          </p>
        </header>
        ...
        <main className="space-y-6">
          ...
          {viewerUrl && (
            <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="text-lg font-semibold text-slate-800">URL del visor (QR)</h2>
          ...
          {qrDataUrl && (
            <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-2 text-sm text-slate-600">
                Imprime este QR. Al escanearlo se abre el visor móvil con la primera página al
                instante.
              </p>
